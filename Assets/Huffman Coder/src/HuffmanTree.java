public class HuffmanTree {
    ...
    // Builds a huffman tree, by polling two least frequency character nodes from the
    // min priority queue and constructs another parent node with frequency as the sum
    // of its children.
    ...
    // This method makes individual nodes of distinct characters with their frequency
    // and adds them to a min priority queue, then returns it.
